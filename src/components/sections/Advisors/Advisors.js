              ...
              <div id="open-modal" class="modal-window">
                ...
                <a href="#modal-close" title="Close" class="modal-close " > &times;</a>
                    <div class="text-right">
                              ...
                              <ul>
                                  ...
                                  <li> درجة الماجستير في الادارة الهندسية من جامعة كوينزلاند للتكنولوجيا في استراليا</li>
                                  <li> درجة الدكتوراه من جامعة جريفيت في استراليا في تخصص الهندسة الصناعية</li>
                                  </ul>
                             <h5>الخبرات العملية</h5>
                             <ul>
                                        <li> مساعد مدير ببرنامج اعداد المدراء في مجموعة صافولا</li>
                                     
                                        <li> رئيس قسم الهندسة الصناعية في جامعة الملك عبدالعزيز</li>
                ...
                <a href="#modal-close" title="Close" class="modal-close " > &times;</a>
                    <div class="text-right">
                              ...
                              <li>بكالوريس في هندسة نظم التصنيع من جامعة واروك في بريطانيا</li>
                                        ...
                                        <li>دكتوراه في الادارة الهندسية من جامعة مانشيستر في بريطانيا</li>
                                  </ul>
                             <h5>الخبرات العملية</h5>
                             <ul>
                ...
                <a href="#modal-close" title="Close" class="modal-close " > &times;</a>
                    <div class="text-right">
                              ...
                              <li>بكالوريس في الهندسة نظم الصناعية من جامعة الملك عبدالعزيز</li>
                                        <li>دبلوم في ادارة الموارد البشرية مناكاديمية التعلم الاوروبية ببريطانياي</li>
                                        <li>ماجستير في الادارة الهندسية من جامعة واروك في بريطانيا</li>
