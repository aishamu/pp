...
<h4>الاستشارات الصناعية</h4></th>
  ...
  <li style={{textAlign : 'right'}} > التخطيط الاستراتيجي واعداد خطة العمل</li>
  <li style={{textAlign : 'right'}} > التطوير الاداري وتطوير الاعمال</li>
  <li style={{textAlign : 'right'}} >  حوكمة الشركات</li>
  <li style={{textAlign : 'right'}} >  عمليات اعادة الهيكلة</li>
 
 

  
  <li style={{textAlign : 'right'}} >     عمليات صناعة و تحليل القرار</li>
  <li style={{textAlign : 'right'}} >  تصميم الخطط النتعلقة بريادة الاعمال</li>
  <li style={{textAlign : 'right'}} >  تحليل و تطوير الانظمة المتعلقة بسلاسل الامداد</li>
  <li style={{textAlign : 'right'}} > تطوير و رفع كفاءة ادارة المواد البشرية وادارتها</li>
  ...
  <li style={{textAlign : 'right'}} >تخطيط العمليا و تبسيط الاجراءات</li>
  <li style={{textAlign : 'right'}} >حلول التمويل الصناعي و ذلك عن طريق : صندوق التنمية الصناعي- البنوك-المستثمرين</li>
